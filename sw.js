const CACHE = 'sproochentest-v20.0.0';
const ASSETS = ['./','index.html','manifest.json','fixes.js','oral.js','patch-v197.js','patch-v198.js','patch-v199.js','patch-v200.js','flag.svg','icon-192.png','icon-512.png'];
...
async function patchedIndex(){
  ...
  html = html.replace('</body>','<script src="./fixes.js?v=19.5"></script><script src="./oral.js?v=19.6"></script><script src="./patch-v197.js?v=19.7"></script><script src="./patch-v198.js?v=19.8"></script><script src="./patch-v199.js?v=19.9"></script><script src="./patch-v200.js?v=20.0"></script></body>');
